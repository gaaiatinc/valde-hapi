...
dbMgr.init = function(config) {
    if (!app_config.get("app:database")) {
        ...
        logger.info("APP database: " + app_config.get("app:database:database"));
 ...
 */
dbMgr.findOne = function(collectionName, query, options) {
 ...
 * @return {[type]}                [description]
 */
dbMgr.findOneAndDelete = function(collectionName, query, options) {
 ...
 * @return {[type]}                [description]
 */
dbMgr.findOneAndReplace = function(collectionName, query, replacement, options) {
    options = options || {};
 ...
 * @return {[type]}                [description]
 */
dbMgr.findOneAndUpdate = function(collectionName, query, updates, options) {
    options = options || {};
