...
/**
 * Insert single doc into collection. Adds a createdDate field.
...
dbMgr.insertOne = function (collectionName, doc, options) {
    return Q.Promise(function (resolve, reject) {
        ...
        doc.createdDate = doc.createdDate || datestamp;
...
dbMgr.updateOne = function (collectionName, query, doc, options) {
    return Q.Promise(function (resolve, reject) {
        ...
        //doc.$currentDate = {date_last_updated: true}; //$currentDate is a mongo 2.6+ feature
        if (doc.$set) {
            doc.$set.date_last_updated = date_last_updated;
        } else {
            doc.date_last_updated = date_last_updated;
        }
...
dbMgr.getCollections = function () {
    return Q.Promise(function (resolve, reject) {
        dbInstance.collections()
            .then(function (docs) {
                let cache = [];
                let result = JSON.stringify(docs, function (key, value) {
...
function _replaceId(match) {
    if ((typeof match === "object") && match.hasOwnProperty("_id")) {
        try {
            ...
            } else if (match._id === null) {
                match._id = new mongo.ObjectID();
            }
        } catch (ex) {
            match._id = null;
        }
