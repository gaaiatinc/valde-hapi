...
AcceptLanguage.prototype.prune_ = function(languageTags) {
    ...
    if (object_size(this.languageTags_) > 0) {
        languageTags = languageTags.filter((languageTag) => {
            ...
            if (languageTag.region) {
                ...
                return {value: this_.languageTags_[language].onlyLanguageValue, language: language, region: null, quality: languageTag.quality};
