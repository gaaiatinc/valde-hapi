...
var IsomorphicTemplate = function (_React$Component) {
    ...
    (0, _createClass3.default)(IsomorphicTemplate, [{
        ...
        value: function render() {
            ...
            var app_mount_code = " if (typeof window !== \"undefined\" && window.document && window.document.createElement) {" + " var appElement = React.createElement(window.PageBundle.default,   {model: window.model}); " + " ReactDOM.hydrate(appElement, window.document.getElementById(\"app-element-mountpoint\")); " + "}";
            ...
            var app_element_div = _react2.default.createElement("div", { id: "app-element-mountpoint", dangerouslySetInnerHTML: { __html: app_element_markup } });
            ...
            var modelBrowserElement = _react2.default.createElement("script", { dangerouslySetInnerHTML: { __html: modelVarStr } });
            ...
            var html = _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    " ",
                    _react2.default.createElement("script", { dangerouslySetInnerHTML: { __html: app_mount_code }, charSet: "UTF-8" }),
                    " ",
                    body_end_element
                )
            );
