...
const perform_react_render = (page_css_assets, app_script_url, isomorphic_template, model) => {
    ...
    if (model.renderEngineDirectives && model.renderEngineDirectives.staticRender) {
        ...
        if (typeof isomorphic_template.default === "function") {
            ...
            if (typeof pageBundleObj.filterModel === "function") {
                isomorphic_props.filter_model = pageBundleObj.filterModel;
            } else if (typeof PageBundle.default.filterModel === "function") {
                isomorphic_props.filter_model = PageBundle.default.filterModel;
            }
