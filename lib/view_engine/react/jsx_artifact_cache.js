...
function createCacheEntry(jsxEntryRelativePath, next) {
    ...
    function __publishCompiledJSX(jsCode) {
        ...
        jsxCacheEntry.resourceHashFileNameDescriptor = path.posix.join("/res/js/", path.posix.dirname(jsxEntryRelativePath), "page.js");
    ...
    function __publishPageCSS() {
        ...
        function __publishPageCSS(pageCSS) {
            ...
            jsxCacheEntry.pageCSSHashFileNameDescriptor = path.posix.join("/res/css", path.dirname(jsxEntryRelativePath), "page.css");
    ...
    function __publishGlobalCSS() {
        ...
        function __publishGlobalCSS(globalCSS) {
            ...
            jsxCacheEntry.globalCSSHashFileNameDescriptor = path.posix.join("/res/css", "global.css");
    ...
    let allTasks = [__checkIfFullGenIsNeeded, __compileJSX, __updateDependencies, __loadCompiledJSX, __publishCompiledJSX, __publishPageCSS, __publishGlobalCSS];
