...
function createCacheEntry(jsxEntryRelativePath, next) {
    ...
    console.log(">>>>", jsxEntryRelativePath);
    var compiledJSXFilePath = path.resolve(jsxCompiler.getStaticResourceFolder() + "/" + jsxEntryRelativePath + ".js");
    console.log(">>>>", jsxCompiler.getStaticResourceFolder());
