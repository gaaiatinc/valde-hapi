                ...
                if (err) {
                    ...
                    try {
                        ...
                        if (typeof renderer.default === "function") {
                            //let temp01 = new renderer.default({ openingBalance: 0 });
                            let temp01 = React.createElement(renderer.default, {openingBalance: 0, id: "qqqqqqqq"});

                            muckHtml = ReactDOMServer.renderToStaticMarkup(temp01);
                        }
                    } catch (err) {
                        logger.error(err.stack);
                    }
