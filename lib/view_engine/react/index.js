...
let logger = logger_factory.getLogger("ReactViewEngine", (app_config.get("env:production") || app_config.get("env:sandbox")) ? "WARN" : "DEBUG");
...
function __performIsomorphicRendering(processingContext) {
    return Q.Promise((resolve, reject) => {
        ...
        let markup = (run_mode !== "production") ? "<h1>React engine default markup!!</h1>" : "<h1></h1>";
