...
module.exports.register = function (server, options, next) {
    ...
    server.ext("onPreHandler", function (request, reply) {
        ...
        if ((!request.state) || !(request.state[cookie_settings.tr_cookie])) {
            ...
            request.state[cookie_settings.tr_cookie] = visitor_tracking_cookie;
        } else {
            visitor_tracking_cookie = request.state[cookie_settings.tr_cookie];
        }
...
function generate_visitor_tracking_cookie(request, reply) {
    ...
    visitor_tr_cookie.locale = request.__valde.locale;
