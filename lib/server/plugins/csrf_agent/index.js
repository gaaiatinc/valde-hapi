...
const options_schema = Joi.object({password: Joi.string().required(), enabled: Joi.boolean().default(false)}).required();
...
module.exports.register = (server, options, next) => {
    ...
    server.ext("onPostAuth", (request, reply) => {
        ...
        if (request.route.settings.plugins["csrf_agent"] && request.route.settings.plugins["csrf_agent"].enabled !== undefined) {
