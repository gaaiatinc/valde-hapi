                    ...
                    try {
                        ...
                        try {
                            ...
                            if (redirect_to_signin) {
                                let append_next_phrase = app_config.get("platform:plugins:hapi_auth_cookie:appendNext") || "redirect_uri";
                                let redirect_uri = (
                                ...
                                let redirect_str = app_config.get("platform:plugins:hapi_auth_cookie:on_auth_failure_redirect_to") + "?" + append_next_phrase + "=" + sanitized_redirct_url;
                                return h.redirect(redirect_str).takeover();
                            } else {
